...
const ListFriend = () => {
    ...
    return (
        <div className="border flex space-x-3 py-1 items-center justify-start TabletPoint:justify-start TabletPoint:space-x-0 TabletPoint:items-center TabletPoint:flex-col mx-auto w-[100%] TabletPoint:max-h-[77vh] TabletPoint:max-w-[98%] ListFriendContainer">
            {
