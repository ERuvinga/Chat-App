...
const Index = (datas: NewMessages) => {
    ...
    return (
        <div className=' flex flex-row w-[80px] h-[80px] TabletPoint:h-[100%] TabletPoint:w-[95%] TabletPoint:justify-center Container-user  TabletPoint:items-center TabletPoint:my-3'
            onClick={() => {
